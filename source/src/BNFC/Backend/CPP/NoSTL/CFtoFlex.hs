...
prelude inPackage = unlines
  [
   ...
   "%{",
   "#define yylval " ++ nsString inPackage ++ "lval",
   "#define yylloc " ++ nsString inPackage ++ "yylloc",
   "#define YY_BUFFER_APPEND " ++ nsString inPackage ++ "_BUFFER_APPEND",
   "#define YY_BUFFER_RESET " ++ nsString inPackage ++ "_BUFFER_RESET",
   "#define init_lexer " ++ nsString inPackage ++ "_init_lexer",
   "#include <string.h>",
   "#include \"Parser.H\"",
   ...
   "static void update_loc(" ++ nsString inPackage ++ "::YYLTYPE* loc, char* text)",
   "{",
